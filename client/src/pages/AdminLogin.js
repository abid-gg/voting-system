    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <h2 style={{ margin: 0, color: '#1976d2', fontWeight: 700, fontSize: 28 }}>Admin Login</h2>
          <p style={{ color: '#555', margin: '8px 0 0 0', fontSize: 16 }}>Access the admin dashboard</p>
        </div>
        <form onSubmit={handleSubmit}>
          <label htmlFor="username" style={{ fontWeight: 600, color: '#1976d2', fontSize: 15, marginBottom: 4, display: 'block' }}>Username</label>
          <input
            id="username"
            type="text"
